  ...
  return (
    <>
      <Seo
        ...
        keywords="learn climbing Pakistan, how to start climbing Pakistan, climbing guide Pakistan, sport climbing tutorial Pakistan, indoor climbing Pakistan, rock climbing Pakistan, climbing disciplines explained, climbing scoring Pakistan"
        path="/learn"
      />
      ...
      <section className="page-header page-header--enhanced">
        ...
        <div className="container">
          <div className="hero-entrance">
            ...
            <p className="page-sub">Start here. A plain-language introduction to the sport, its disciplines, how scoring works, and how to get on the wall yourself.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <StaggeredGrid className="learn-card-grid" baseDelay={0.04} stepDelay={0.07}>
            ...
            {sections?.map((section, i) => (
              <a href={`/learn/${section.slug}`} className="learn-card" key={section.slug}>
                <div className="learn-card-media">
                  ...
                  <span className="learn-card-num">{String(i + 1).padStart(2, '0')}</span>
                </div>
                <div className="learn-card-body">
                  {section.subtitle && <span className="learn-card-subtitle">{section.subtitle}</span>}
                  <h3>{section.title}</h3>
